...
#      title_str = "Director signal " + svals[2] + "d, " + svals[4] + "h, " + svals[7] + "m"
      title_str = "Cargo signal " + svals[2] + "d, " + svals[4] + "h, " + svals[7] + "m"
...
#  circles(xvals,yvals, s=rvals, color=rgbs, alpha=1.0, edgecolor='black')
  circles(xvals,yvals, s=rvals, color=rgbs, alpha=1.0)
